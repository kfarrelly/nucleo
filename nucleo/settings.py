...
# StellarNotifier
STELLAR_NOTIFIER_HOSTNAME = os.environ.get('STELLAR_NOTIFIER_HOSTNAME')
STELLAR_NOTIFIER_PORT = os.environ.get('STELLAR_NOTIFIER_PORT')
STELLAR_NOTIFIER_SUBSCRIPTION_URL = '{0}:{1}{2}'.format(STELLAR_NOTIFIER_HOSTNAME,
    STELLAR_NOTIFIER_PORT, '/api/subscription/')
